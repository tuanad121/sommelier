...
class KaggleStageDiarizationNotebookTests(unittest.TestCase):
    ...
    def test_notebook_runs_one_manual_audio_path_and_prints_results(self):
        ...
        self.assertIn("BOUNDARY_REFINE_REFERENCE_MIN_SEGMENT = 2.0", joined)
        self.assertIn("BOUNDARY_REFINE_NESTED_MAX_SEGMENT = 1.0", joined)
        ...
        self.assertIn("Bật/tắt bước refine boundary sau diarization", joined)
        self.assertIn("Kiểm tra đầu/cuối từng segment trên toàn bộ diarization", joined)
        self.assertNotIn("giữa 2 speaker", joined)
        ...
        self.assertIn("--boundary-refine-reference-min-segment", joined)
        self.assertIn("--boundary-refine-nested-max-segment", joined)
    ...
    def test_stage_diarization_notebook_builder_tracks_update_source(self):
        ...
        self.assertIn('"BOUNDARY_REFINE_REFERENCE_MIN_SEGMENT": "2.0"', builder)
        self.assertIn('"BOUNDARY_REFINE_NESTED_MAX_SEGMENT": "1.0"', builder)
