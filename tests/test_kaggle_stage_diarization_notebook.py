...
class KaggleStageDiarizationNotebookTests(unittest.TestCase):
    def test_stage1_update_source_notebook_has_no_boundary_refine_or_resegmentation_controls(self):
        ...
        self.assertNotIn("SPEAKER_RESEGMENTATION", joined)
        self.assertNotIn("RESEGMENTATION_", joined)
        self.assertNotIn("--speaker-resegmentation", joined)
        self.assertNotIn("--resegmentation-", joined)
    ...
    def test_notebook_runs_one_manual_audio_path_and_prints_results(self):
        ...
        self.assertNotIn("--speaker-resegmentation", joined)
        self.assertNotIn("--resegmentation-", joined)
        self.assertNotIn("sliding_window", joined)
    ...
    def test_stage_diarization_notebook_builder_tracks_update_source(self):
        ...
        self.assertNotIn('"SPEAKER_RESEGMENTATION', builder)
        self.assertNotIn('"RESEGMENTATION_', builder)
