...
SYNC_ASSIGNMENT_NAMES = (
    ...
    "AUDIO_GAIN_CLAMP_DB",
    "SPEAKER_BOUNDARY_REFINEMENT",
    "BOUNDARY_REFINE_MAX_SHIFT",
    "BOUNDARY_REFINE_STEP",
    "BOUNDARY_REFINE_EMBED_WINDOW",
    "BOUNDARY_REFINE_REFERENCE_MIN_SEGMENT",
    "BOUNDARY_REFINE_NESTED_MAX_SEGMENT",
    "BOUNDARY_REFINE_MIN_SEGMENT",
    "BOUNDARY_REFINE_MAX_GAP",
    "BOUNDARY_REFINE_MIN_IMPROVEMENT",
    "BOUNDARY_REFINE_ENDPOINT_GATE",
    "BOUNDARY_REFINE_ENDPOINT_WINDOW",
    "BOUNDARY_REFINE_ENDPOINT_MARGIN",
...
DEFAULT_ASSIGNMENTS = {
    ...
    "SPEAKER_BOUNDARY_REFINEMENT": "True",
    "BOUNDARY_REFINE_MAX_SHIFT": "0.4",
    "BOUNDARY_REFINE_STEP": "0.05",
    "BOUNDARY_REFINE_EMBED_WINDOW": "0.4",
    "BOUNDARY_REFINE_REFERENCE_MIN_SEGMENT": "2.0",
    "BOUNDARY_REFINE_NESTED_MAX_SEGMENT": "1.0",
    "BOUNDARY_REFINE_MIN_SEGMENT": "0.3",
    "BOUNDARY_REFINE_MAX_GAP": "0.35",
    "BOUNDARY_REFINE_MIN_IMPROVEMENT": "0.05",
    "BOUNDARY_REFINE_ENDPOINT_GATE": "True",
    "BOUNDARY_REFINE_ENDPOINT_WINDOW": "0.4",
    "BOUNDARY_REFINE_ENDPOINT_MARGIN": "0.05",
