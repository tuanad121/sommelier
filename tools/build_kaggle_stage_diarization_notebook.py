...
SYNC_ASSIGNMENT_NAMES = (
    ...
    "AUDIO_GAIN_CLAMP_DB",
    "SPEAKER_RESEGMENTATION_AUDIT",
    "RESEGMENTATION_PYANNOTE_MODEL_NAME",
    "RESEGMENTATION_BOUNDARY_WINDOW",
    "RESEGMENTATION_INTERIOR_MIN_DURATION",
    "RESEGMENTATION_MAX_SHIFT",
    "RESEGMENTATION_MAX_EXTEND",
    "RESEGMENTATION_MIN_DURATION",
    "RESEGMENTATION_MIN_OVERLAP_DURATION",
    "RESEGMENTATION_MIN_MAPPING_SCORE",
    "RESEGMENTATION_MIN_MAPPING_MARGIN",
    "RESEGMENTATION_REFERENCE_MIN_SEGMENT",
    "RESEGMENTATION_REFERENCE_MAX_SEGMENTS",
